...
function spawnMeteor() {
    ...
    if (meteor) return; // aynı anda tek meteor
    ...
    // ALEV
    const flameGeometry = new THREE.SphereGeometry(0.35, 32, 32);
...
function animate() {
    ...
    if (meteor) {
        ...
        meteor.position.add(direction.clone().multiplyScalar(0.08));
